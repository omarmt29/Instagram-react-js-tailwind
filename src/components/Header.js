                                    ...
                                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                        <div className="sm:flex sm:items-start">
                                            ...
                                            <div className="mt-3 text-center">
                                                ...
                                                <input type="text" placeholder='Image url' className='p-2 outline-none border-b-4 w-full mb-3'/>
                                                <input type="text" placeholder='Nombre' className='p-2 outline-none border-b-4 w-full mb-3'/>
                                                <input type="text" placeholder='Nickname' className='p-2 outline-none border-b-4 w-full mb-3'/>
                                                <input type="text" placeholder='Mensaje' className='p-2 outline-none border-b-4 w-full mb-3'/>
